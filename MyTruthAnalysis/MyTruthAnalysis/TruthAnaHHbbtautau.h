...
private:
  ...
  // vbf-tag (VT) jet
  double m_fVTjet0_pt;                //!
  double m_fVTjet0_phi;               //!
  double m_fVTjet0_eta;               //!
  double m_fVTjet1_pt;                //!
  double m_fVTjet1_phi;               //!
  double m_fVTjet1_eta;               //!
  double m_fDeltaR_VTjetVTjet;        //!
  double m_fDeltaEta_VTjetVTjet;      //!
  double m_fMVTjetVTjet;              //!
